public class CafeJava {
    public static void main(String[] args) {
        ...
        // Scenario 2
        //Noah ordered a cappuccino. Use an if statement to check the status of his order and print 
        //the correct status message. If it is ready, also print the message to 
        //display the total. Note: Outcomes may be different depending on what you assigned as the status.
        if(isReadyOrder4) {
        ...
        //Next, use an if statement to print the appropriate order status message. Change the 
        //isReady flag value from true to false or vice versa in order to test your control logic (if-statement).
